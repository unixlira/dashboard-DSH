                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="row m-t-5 mb-2">
                                            ...
                                            <div class="col-6 progress_ltr">
                                                <div class="progress">
                                                    <div class="progress-bar bg-mint" role="progressbar" style="width: 60%" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="bg-white section_border">
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-12">
                                <form action="{{URL::to('widgets1')}}" id="widgets_login_validator"  class="login_validator header_align">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-12">
                                                <input type="submit" value="Log In" class="btn btn-primary btn-block login_button m-t-15">
                                            </div>
                                        </div>
                                    </div>
                                </form>
