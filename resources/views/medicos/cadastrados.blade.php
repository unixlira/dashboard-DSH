...
var TableAdvanced = function() {
    ...
    var initTable1 = function() {
        var table = $('#medicos');
            ...
            "processing": true,
            "ajax": "{{ route('datatable.getMedicos', 0) }}",
            "columns": [
                {
                ...
                {data: 'ID', "render": function ( data, type, row, meta )
                    {
                            if ("{{Request::session()->get('permissao',1)}}" != 2) {
                                return '<a href="detalhes/'+data+'" data-toggle="tooltip" data-placement="top" title="Visualizar" class="margemDir" data-original-title="Visualizar"><i class="fa fa-eye" style="color:#4fa6b5;"></i></a><a class="delete hidden-xs hidden-sm" data-toggle="tooltip" data-placement="top" title="Bloquear Médico" href="bloquear/'+data+'" data-original-title="Bloquear"><i class="fa fa-ban"style="color:#ee268f"></i></a>';
                            }else{
                                return '<a href="detalhesparticipante/'+data+'" data-toggle="tooltip" data-placement="top" title="" class="margemDir" data-original-title="Visualizar"><i class="fa fa-eye text-success"></i>';                       
                        } 
                    }
                }
            ],
        ...
        */
        ...
        function fnFormatDetails(dados) {
            console.log(dados[0].assistidas);
            let AulasCompletas = 0;
            let i = 0;
            if (typeof dados[0].assistidas != 'undefined') {
                AulasCompletas = dados[0].assistidas;
            }         
            

            var sOut = '<div class="row col-12">';
            sOut += '<div class="col-lg-2"><b>Aulas Assistidas</b>:  '+AulasCompletas+'</div>';
        ...
        table.on('click', ' tbody td .row-details', function() {
            ...
            if ( row.child.isShown() ) {
                ...
                $(this).addClass("row-details-open").removeClass("row-details-close");
                 $.get({url: "/aulasAssistidas/"+id, success: function(resultado){
