                ...
                <div class="card">
                    <div class="card-body m-t-15">
                        <div class="pull-right" style="margin-top: -5px !important;">
                            <a href="{{ URL::to('arquivos/adicionar') }}" id="editable_table_new" class="btn btn-info">
                                Upload de Arquivos  <i class="fa fa-plus"></i>
                            </a>
                        </div>
                        <table class="table table-striped table-bordered table-hover dataTable no-footer textoEsquerda" id="teste" role="grid">
                            ...
                            <tr role="row">
                                ...
                                <th class="sorting wid-20" tabindex="0" rowspan="1" colspan="1">Nome do Arquivo</th>
                                <th class="sorting wid-20" tabindex="0" rowspan="1" colspan="1">Tamanho</th>
...
var TableAdvanced = function() {
    ...
    var initTable1 = function() {
        ...
        table.DataTable({
            "processing": true,
            "serverSide": true,
            "ajax": "{{ route('datatable.getarquivos') }}",
            "columns": [
                ...
                {data: 'nome_arquivo', name: 'nome_arquivo'},
                {data: 'tamanho', name: 'tamanho'},
                {data: 'nome', name: 'usuarios.nome'},
                {data: 'id', "render": function ( data, type, row, meta )
                    {
                      return '<a href="excluirarquivo/'+data+'" data-toggle="tooltip" data-placement="top" title="Excluir" class="margemDir"><i class="fa fa-trash text-danger"></i></a><a class="edit margemDir" data-toggle="tooltip" data-placement="top" title="Baixar" href="baixar/'+data+'" data-original-title="Baixar"><i class="fa fa-arrow-down text-success iconeRestaura"></i></a>';
                    }
                }
            ],
