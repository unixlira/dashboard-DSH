            ...
            <div class="row no-gutters">
                ...
                <div class="col-lg-6 col-md-8 col-sm-8">
                    <ol class="breadcrumb float-right nav_breadcrumb_top_align">
                        ...
                        <li class="breadcrumb-item active">Imagens Gatilho</li>
                    </ol>
                </div>
            </div>
        </div>
                            ...
                            <div>
                                <div class="nav-tabs-custom">
                                    <ul class="nav nav-tabs">
                                        <li class="nav-item">
                                            <a href="#tab_2" class="nav-link active" data-toggle="tab">Imagens Gatilho</a>
                                        </li>
                                        <div class="divdireita margemBaixo">
                                            <a href="{{ URL::to('galeria/novaimagem') }}" id="editable_table_new" class="btn btn-info margemDir">
                                        ...
                                        <div class="tab-pane active gallery-padding" id="tab_2">
                                            <div class="row no-gutters" >
                                                ...
                                                <div class="col-xl-1 col-lg-3 col-md-4 col-6 gallery-border" align="center">
                                                    ...
                                                    <a class="fancybox-buttons zoom thumb_zoom" data-fancybox-group="button" href="{{asset('assets/img/galeriaimg/'.$i->imagem)}}">
                                                        <img src="{{asset('assets/img/galeriaimg/thumbs/'.$i->imagem)}}" class="img-fluid"></a>
                                                </div>
                                                @endforeach
                                            </div>
                                        </div>
