                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item bg-success">
                                <a href="mail_draft" class="mail_inbox_text_col">
                                    <span class="badge badge-warning badge-pill float-right">16</span>
                                    <i class="fa fa-recycle"></i>
                                    Draft
                                </a>
                            </li>
                                ...
                                <a href="#">
                                    ...
                                    <span class="float-left">
                                            <img src="{{asset('assets/img/mailbox_imgs/1.jpg')}}"
                                                 class="rounded-circle img-fluid float-left inbox_contact_img" alt="Image">
                                        </span>
                                </a>
                            </li>
                            <li class="list-group-item status_height">
                                ...
                                <a href="#">
                                    ...
                                    <span class="float-left">
                                            <img src="{{asset('assets/img/mailbox_imgs/3.jpg')}}"
                                                 class="rounded-circle img-fluid float-left inbox_contact_img" alt="Image"></span>
                                </a>
                            </li>
                            <li class="list-group-item status_height">
                                <a href="#">
